...
function getBigger (bigger, atual) {
  if (atual > bigger) {
    bigger = atual
  }
  return bigger
...
console.log(numbers.reduce(sumPar, 0)); */
...
const soma = numbers.filter(getEven).reduce(sumPair);
console.log(soma); */
...
const estudantes = [
  {
    ...
    materias: [
      ...
      { name: 'Português', nota:  69},
      { name: 'Química', nota: 70 },
      { name: 'Biologia', nota: 79 },
    ],
  },
  {
    nome: 'Mario',
